...
- **Play workspace** (first-run default, **Make**) — sidebar footer / Profile → Appearance: Cast, Fitting Room, Day Planner, Roleplay, Gallery, and Queue. Studio is **Control**; Full is **Build**. Welcome asks **What do you want to make?** (Character / Scene·Film / Image / Surprise) before Heal & ready. Moodboard lives under Scene nav and ⌘K. Simple remains available for a lean essentials layout.
